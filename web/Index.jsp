	...
	<div class="container" id="container">
                <div class="form-container sign-up-container">
                    <form action="#">
                                ...
                                <span>use sus datos para registrarse</span>
                ...
                <div class="form-container sign-in-container">
                    <form action="Session" method="post">
                                <h1 style="color:black;">INICIAR SESSION</h1>
                                <div class="social-container">
                                    <img src="Logo.png" width="100">
                                </div>
                                <c:if test="${bandera==1}"><span style="color: red">Error en usuario o password</span></c:if>
                                <input type="text" name="usuario" placeholder="usuario" />
                                <input type="text" name="password" placeholder="contraseña" />
                ...
                <div class="overlay-container">
                        <div class="overlay">
                                ...
                                <div class="overlay-panel overlay-right">
                                        ...
                                        <a href="InicioUser?action=add&aux=1"><button class="ghost" id="signUp">CREAR UNA CUENTA</button></a>
